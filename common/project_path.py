...
# 测试用例的路径
case_path = os.path.join(project_path_2, 'testing.xlsx')  # 拼接

# 测试报告路径
report_path = os.path.join(project_path_2, 'jiekou_Result', 'test_report', 'test_report.html')

# 测试日志路径
log_path = os.path.join(project_path_2, 'jiekou_Result', 'test_log', 'test.log')
